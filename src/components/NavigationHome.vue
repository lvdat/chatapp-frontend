<template>
    <nav class="navbar navbar-expand-lg bg-body-tertiary home_navbar">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#">For Developers</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="#">Desktop App</a>
                    </li>
                </ul>
            </div>
        </div>
